...
Idle time-to-empty: hunger 2.0 game-days, thirst 1.0 game-day, rest one wake window (dawn+day+dusk). A full night in a bed refills rest; sleeping rough refills half; staying up does not. Labor / cold-band / injury-recovery are reserved drain muls. Food, water, and sleep refill: [0005](0005-food-cook-spoilage.md) and [0003](0003-jobs-and-need-seek.md).
...
- Prose: [0006](0006-needs-presentation.md) (`a_little_*` → “uncomfortable”).
- Sources, Cook, jobs, generator: [0002](0002-temperature-hygiene-sources.md)–[0005](0005-food-cook-spoilage.md). They do not reopen ranges or thresholds.
