...
- [14 — Loadout upkeep (wear + Repair)](issues/14-loadout-upkeep.md) — **Q1:A Q2:A Q3:A.** Wear on hit; Repair job (scrap + campfire); Modify deferred. ADR [0014](../../docs/adr/0014-loadout-upkeep.md).

## Building now

Early-alpha tickets 01–13 shipped. Ticket 14 (loadout upkeep) is the live M2 leftover from roadmap §4.
...
6. **Building:** [14 — wear + Repair](issues/14-loadout-upkeep.md) — ADR 0014.
...
- Farm/Hunt/Craft/Modify/Firefight stub Jobs; succession chooser UI; grief/morale; attachment readers.
## Out of scope
