...
- [05 — One unique NPC as framework for future](issues/05-unique-npc.md) — **Mara Okoro, clinic nurse.** CON 7/STR 3/DEX 5 (15). `survivors/uniques/*.json` + `survivor.schema.json`, `survivor` CONTENT_TYPE, grid-lite Doctor 1/Guard 2/Rest 3, portrait+barks, one-chance permadeath, director beat day 1 annex. N more without code change; hot-reload re-runs seed.
